    ...
    <div className="relative w-full desktop:px-72">
      <div className="grid desktop:grid-cols-2 desktop:gap-24">
        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            <MainSprayBg className="-left-20 -top-250 h-700 w-full -rotate-30 tablet:-left-30 tablet:-top-336 tablet:h-900 tablet:w-full desktop:-top-270 desktop:h-800 desktop:w-800" />
